def get_conditional_user_table_creation_query():
   return 'CREATE TABLE IF NOT EXISTS Users ( uid int(11) NOT NULL AUTO_INCREMENT, username varchar(30) NOT NULL, email varchar(30) NOT NULL, password varchar(32) NOT NULL, PRIMARY KEY (uid) );' 
